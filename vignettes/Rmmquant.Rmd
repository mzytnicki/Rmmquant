...
```{r, deseq2}
output   <- RmmquantRun(genomicRanges=gr, readsFiles=bamFiles, sorts=TRUE)
#output   <- RmmquantRun(genomicRanges=gr, readsFiles=bamFiles, sampleNames=sampleNames, sorts=TRUE, nThreads=6)
